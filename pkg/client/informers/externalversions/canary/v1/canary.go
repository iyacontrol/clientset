...
import (
	...
	versioned "github.com/iyacontrol/clientset/pkg/client/clientset/versioned"
	internalinterfaces "github.com/iyacontrol/clientset/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/iyacontrol/clientset/pkg/client/listers/canary/v1"
...
func (f *canaryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&canary_v1.Canary{}, f.defaultInformer)
}
